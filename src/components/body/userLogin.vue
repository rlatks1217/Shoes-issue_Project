<template>
  <div class="container" style="">
    <div class="row justify-content-center mt-5">
      <div class="col-md-6">
        <div class="card">
          <div class="card-header text-center" style="background-color: rgb(237, 241, 214); color: black">로그인을 해주세요</div>
          <div class="card-body">
            <form>
              ...
              <br />
              <button @click.prevent="example" class="btn btn-primary btn-block mx-auto d-block" style="background-color: rgb(237, 241, 214); color: black; border-color: rgb(237, 241, 214)">
                로그인
              </button>
            </form>
            <br />
            <button @click.prevent="kakaoLoginBtn" class="btn btn-primary btn-block mx-auto d-block" style="background-color: yellow; color: black; border-color: yellow">카카오 로그인</button>
          </div>
        </div>
      </div>
    </div>
