      ...
      <template>
        <div class="form-container">
          <div class="row justify-content-center mt-5">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header text-center" style="background-color: rgb(237, 241, 214); color: black">정보수정</div>
                <div class="card-body d-flex">
                  ...
                  <div class="form-right">
                    <form>
                      <div class="card-body">
                        <img :src="tradeImage" style="width: 120px; height: 120px" />
                ...
                <div class="card-body d-flex justify-content-between">
                  ...
                  <div class="d-flex justify-content-between mb-3">
                    <button @click.prevent="deleteUser()" class="btn btn-primary" style="background-color: rgb(237, 241, 214); color: black; border-color: rgb(237, 241, 214)">아이디 삭제하기</button>
                  </div>
                  <div class="d-flex justify-content-between mb-3">
                    <button @click.prevent="updateUser()" class="btn btn-primary" style="background-color: rgb(237, 241, 214); color: black; border-color: rgb(237, 241, 214)">내 정보 수정하기</button>
                  </div>
                </div>
              </div>
            </div>
